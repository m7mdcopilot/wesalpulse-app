            ...
            <div className="ml-2 space-y-1">
              ...
              >
                <a href="/profile" className="flex items-center">
                  <SquareUserRound className="h-4 w-4 mr-3 text-primary" />
                  {!isCollapsed && <span className="font-medium text-foreground group-hover:text-primary transition-colors">Profile</span>}
                </a>
              </Button>
              <Button
                variant="ghost"
          ...
          {expandedItems.includes('settings') && (
            <div className="ml-2 space-y-1">
              <Button
                ...
                asChild
              >
                <a href="/settings/general" className="flex items-center">
                  <Settings className="h-4 w-4" />
                  {!isCollapsed && <span className="ml-3 font-medium text-foreground group-hover:text-primary transition-colors">General</span>}
                </a>
              </Button>
              <Button
                variant="ghost"
                ...
                asChild
              >
                <a href="/settings/users" className="flex items-center">
                  <Users className="h-4 w-4" />
                  {!isCollapsed && <span className="ml-3 font-medium text-foreground group-hover:text-primary transition-colors">Users</span>}
                </a>
              </Button>
            </div>
          )}
